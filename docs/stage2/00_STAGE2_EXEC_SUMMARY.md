...
📌 2️⃣ Что дальше
🔘 M2 (Import by date + preview + job)
🔘 M3 (Unified ingestion service)
🔘 M4 (Media MVP)
🔘 M5 (Mini app portal)
🔘 M6 (Content/Calendar)
🔘 M7 (Observability)
...
☑️ MTProto импорт по диапазону дат + preview работает
☑️ Нет dual pipeline, один ingestion-service, 0 дублей
