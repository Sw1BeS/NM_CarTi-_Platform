...
📌 3️⃣ DoD (проверки)
✅ `api/health` = 200
✅ TG webhook принимает апдейт и не падает
✅ нет дублей по source ids
✅ мини-приложение создаёт заявку
✅ публикации уходят и статусы корректны
✅ логи доступны в UI
