        ...
        if (this.state.hasError) {
            return (
                <div className="h-screen flex items-center justify-center text-white bg-black px-6 text-center">
                    <div>
                        <div className="text-xl font-bold mb-2 text-red-500">Something went wrong</div>
...
const MiniAppContent = () => {
    ...
    const load = async () => {
        ...
        if (tg && tg.initData) {
            console.log(`[MiniApp] Telegram WebApp detected. Platform: ${tg.platform}, Version: ${tg.version}`);
            tg.ready?.();
            tg.expand?.();
            ...
            console.log(`[MiniApp] Telegram WebApp NOT detected. Running in Preview mode.`);
