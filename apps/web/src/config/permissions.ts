...
export const NAV_ITEMS: NavigationItem[] = [
  ...
  { id: 'nav_leads', labelKey: 'nav.leads', path: '/leads', iconName: 'Users', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER', 'OPERATOR'], order: 3, visible: true },
  { id: 'nav_inv', labelKey: 'nav.inventory', path: '/inventory', iconName: 'Car', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER', 'OPERATOR', 'DEALER', 'VIEWER', 'USER'], order: 4, visible: true },
  { id: 'nav_tele', labelKey: 'nav.telegram', path: '/telegram', iconName: 'Send', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 5, visible: true },
  { id: 'nav_cal', labelKey: 'nav.calendar', path: '/calendar', iconName: 'Calendar', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 6, visible: true },
  { id: 'nav_cont', labelKey: 'nav.content', path: '/content', iconName: 'Library', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 7, visible: true },
  { id: 'nav_scen', labelKey: 'nav.scenarios', path: '/scenarios', iconName: 'Database', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 8, visible: true },
  { id: 'nav_integrations', labelKey: 'nav.integrations', path: '/integrations', iconName: 'Plug', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 9, visible: true },
  { id: 'nav_partners', labelKey: 'nav.partners', path: '/partners', iconName: 'Users', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 10, visible: true },
  { id: 'nav_company', labelKey: 'nav.company', path: '/company', iconName: 'Briefcase', roles: ['SUPER_ADMIN', 'ADMIN', 'OWNER', 'MANAGER'], order: 11, visible: true },
